...
{
    /// <inheritdoc />
    public partial class AddedCategoryAndBlogEntryCategoryEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogEntryCategories", x => new { x.BlogEntryId, x.CategoryId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_BlogEntryCategories_Categories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogEntryCategories_CategoryId",
